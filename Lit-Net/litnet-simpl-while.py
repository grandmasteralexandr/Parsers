...
if __name__ == '__main__':      # типовая конструкция необходимая для выполнения любого скрипта, ее не нужно писать только в случае
    main()                      # если файл нужен только для импорта (чтобы при импорте не выполнился этот код)
